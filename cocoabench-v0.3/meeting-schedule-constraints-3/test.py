"""
Test function for meeting-schedule-constraints-3.
...
EXPECTED_ANSWER = {
    "S1": ("Mon-15:00", "RoomB", ["Carol", "Grace"]),
    "S2": ("Mon-09:00", "RoomB", ["Ivan", "Frank"]),
    "S3": ("Mon-10:00", "RoomB", ["Carol", "Ivan"]),
    "S4": ("Mon-11:00", "RoomB", ["Carol", "Grace", "Ivan", "Frank"]),
}
