"""
Test function for meeting-schedule-constraints-4.
...
EXPECTED_ANSWER = {
    "S1": ("Mon-15:00", "RoomB", ["Judy", "Carol"]),
    "S2": ("Mon-09:00", "RoomB", ["Dan", "Grace"]),
    "S3": ("Mon-10:00", "RoomB", ["Judy", "Dan"]),
    "S4": ("Mon-11:00", "RoomB", ["Judy", "Carol", "Dan", "Grace"]),
}
