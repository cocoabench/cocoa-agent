"""
Test function for wandb-qwen-collapse-detection-2.

Evaluates the run name for the productive expansion task.
"""
...
# Ground truth value
EXPECTED_ANSWER = '''Qwen2.5-Math-1.5B, 2-shot RLVR with pi_{1}, pi_{13}'''
