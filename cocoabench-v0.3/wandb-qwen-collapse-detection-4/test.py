"""
Test function for wandb-qwen-collapse-detection-4.

Evaluates the run name for the stable compression task.
"""
...
# Ground truth value
EXPECTED_ANSWER = "Qwen2.5-Math-7B, 16-shot RLVR with pi_{1},..., pi_{16}"
